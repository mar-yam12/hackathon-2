    ...
    <div>
      ...
      <div className="w-[90%] border-b-2 border-gray-200 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 m-auto">
        ...
        <div className="col-span-full flex justify-center mt-8 mb-12">
          <Button className="text-lg font-Satoshi font-medium text-white px-16 py-2 border-2 border-gray-200 rounded-full hover:bg-white hover:text-black">
          <a href="/productdetails">View All</a> 
          </Button>
        </div>
      </div>
    </div>
