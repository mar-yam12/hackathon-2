  ...
  return (
    <div className="flex font-Satoshi flex-col justify-between items-center m-auto gap-0">
      ...
      <div className="w-[90%] h-[80px] flex justify-start   items-center m-auto">
        ...
        <span className="flex gap-4 sm:h-[58px] sm:w-[654px]  w-[286px] h-[20px] left-4 text-[#000000] lg:left-[100px] top-[150px] text-[20px] sm:text-[28px] sm:mt-[50px] font-semibold mb-2 mx-auto">
          All Reviews 
          <h2 className=" text-lg items-start text-gray-500">(415)</h2>
        </span>
